...
def test_create_or_update_memories():
    ...
    duplicate_messages = [
        MockMessage("user", "My name is Alice and I'm a data scientist"),  # Similar to existing
        MockMessage("user", "I enjoy working with Python and data analysis"),  # New content
    ]
