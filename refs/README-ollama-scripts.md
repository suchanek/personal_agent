...
- `remote` - Switch to remote Ollama server (100.115.62.30:11434)  
...
# Switch to remote Ollama (100.115.62.30)
...
- **Remote**: `OLLAMA_URL=http://100.115.62.30:11434`
  - Points to your remote Ollama server
  - For when using your 100.115.62.30 server
