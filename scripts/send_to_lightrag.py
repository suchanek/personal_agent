...
def main():
    ...
    parser.add_argument(
        "--remote-host",
        default="tesla.tail19187e.ts.net",
        help="Optional: The hostname or IP address of the remote server for SCP transfer (default: tesla.tail19187e.ts.net).",
    )
    parser.add_argument(
        "--remote-user",
        default="suchanek",
    ...
    parser.add_argument(
        "--remote-lightrag-url",
        default="http://tesla.tail19187e.ts.net:9621",
        help="Optional: The URL of the remote LightRAG server API to trigger rescan (default: http://tesla.tail19187e.ts.net:9621).",
    )
