...
def test_multiuser_paths():
    ...
    expected_knowledge_pattern = f"{USER_ID}/knowledge"
    ...
    print(
        f"   Storage path contains '{expected_storage_pattern}': {'✅' if storage_correct else '❌'}"
    )
    print(
        f"   Knowledge path contains '{expected_knowledge_pattern}': {'✅' if knowledge_correct else '❌'}"
    )
    print()
