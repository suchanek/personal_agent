...
memory_db = SqliteMemoryDb(table_name="memory", db_file="/tmp/data/memory.db")
...
web_agent = Agent(
    ...
    markdown=True,
    storage=SqliteStorage(
        table_name="web_agent", db_file="/tmp/data/agents.db", auto_upgrade_schema=True
    ),
)
