        ...
        if user_input:
            try:
                ...
                try:
                    ...
                    if logger:
                        logger.info(
                            f"Native agno agent completed successfully - response length: {len(str(response))}"
                        )
            ...
            <div class="info-section">
                ...
                <div class="info-content">
                    <ul class="tools-list">
                        ...
                        <li><i class="fas fa-brain"></i> SQLite Memory System</li>
                        <li><i class="fas fa-database"></i> LanceDB Vector Storage</li>
