...
async def create_team(use_remote: bool = False):
    ...
    agent_team = Team(
        ...
        instructions=[
            ...
            "Use the memory agent (Personal AI Agent) for personal information and knowledge queries.",
            ...
            "When users ask to remember something, delegate to the memory agent.",
            "When users ask what you remember about them, delegate to the memory agent.",
        ],
        markdown=True,
        show_tool_calls=True,
