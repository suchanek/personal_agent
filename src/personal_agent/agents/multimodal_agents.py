...
from personal_agent.config.settings import DATA_DIR, LLM_MODEL

# Define the storage file for the agents
image_agent_storage_file: str = f"{DATA_DIR}/image_agent.db"
